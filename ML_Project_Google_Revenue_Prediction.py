...
df = load_df(r"https://drive.google.com/open?id=15dDbDxmU0cSApFZ0CKix7QrgkbnJzV1j")
...
#load csv file to a dataframe
test_data = load_df(r"https://drive.google.com/open?id=1cGYnJFlWUIh8kNDUES-E_b_cOfmPJWHR")
...
submit_1.to_csv(r"MENTION THE DESTINATION FOLDER",index=False)
